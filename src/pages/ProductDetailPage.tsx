...
export const ProductDetailPage = () => {
  const productId = '123'; // Example product ID, would come from route params
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-16rem)] p-6">
      <div className="bg-sky-950/20 border border-sky-400/10 backdrop-blur-xl p-10 rounded-[2.5rem] max-w-4xl mx-auto text-center space-y-6 tracking-tight font-medium">
        <h1 className="text-4xl font-bold text-white mb-4">Product: Minimal Tee</h1>
        <p className="text-lg text-white/80 leading-relaxed">A high-quality, comfortable minimalist t-shirt. Perfect for everyday wear.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          ...
          <div className="text-left space-y-4">
            ...
            <p className="text-white/70">Size: <span className="font-semibold">M</span></p>
            <p className="text-white/70">Color: <span className="font-semibold">Black</span></p>
